 ...
 */
/**
 * Update Profile French lexicon for Login
 *
 * @package login
 * @subpackage lexicon
 */
...
$_lang['login.email'] = 'Adresse électronique';
$_lang['login.fax'] = 'Fax';
$_lang['login.fullname'] = 'Nom complet';
$_lang['login.mobilephone'] = 'Téléphone mobile';
$_lang['login.phone'] = 'Téléphone';
$_lang['login.profile_err_nf'] = 'Pofil non trouvé!';
$_lang['login.profile_err_save'] = 'Une erreur est survenue durant la mise à jour du profil.';
